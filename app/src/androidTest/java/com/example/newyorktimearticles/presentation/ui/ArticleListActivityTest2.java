...
public class ArticleListActivityTest2 {
    ...
    public void articleListActivityTest2() {
        ViewInteraction imageView = onView(
                allOf(withId(R.id.ivArticle),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.recArticleList),
                                        3),
                                0),
                        isDisplayed()));
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recArticleList),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.drawer),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvDate), withText("2020-06-09"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.recArticleList),
                                        3),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tvArticleTitle), withText("Free Food, Free Speech and Free of Police: Inside Seattle’s ‘Autonomous Zone’"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.recArticleList),
                                        5),
